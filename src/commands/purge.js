...
module.exports = {
    ...
    async execute(client, message, args, prefix, embColor){
        ...
        if(!message.member.permissions.json.manageMessages|| !message.channel.guild.me.permissions.json.manageMessages) return await message.channel.createMessage("> :x: У бота или у вас недостаточно прав на удаление сообщений.")
